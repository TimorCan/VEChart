...
@property(nonatomic,assign)CGFloat VEChartSpace;

@end

#define VEBarWidth  25
...
-(instancetype)initWithFrame:(CGRect)frame X_values:(NSArray *)x_values Y_values:(NSArray *)y_values{
    ...
    if (self) {
        ...
        //最大值高度
        self.maxHeight = frame.size.height * 0.7 ;
...
-(void)configBarChart
{
    ...
    [y_height enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        CGRect rect1 = CGRectMake(label.frame.origin.x, label.frame.origin.y - 20 , 60, 20);
